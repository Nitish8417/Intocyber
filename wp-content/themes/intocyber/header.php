                    ...
                    <div class="sub-block-header">
                        ...
                        <div class="hamburger-menu">
                            <div class="hamburger-menu-icon">
                                <img src="<?php bloginfo('template_url'); ?>/assets/images/hamburger.svg"
                                    alt="hamburger-menu-icon" class="show">
                                <img src="<?php bloginfo('template_url'); ?>/assets/images/close.svg"
                                    alt="hamburger-menu-icon" class="close">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="block-header">
                                    ...
                                    <div class="nav-in-text">
                                        ...
                                        <div class="menu-list-info">
                                            <p class="p18">Are you ready to accelerate your cybersecurity sales? Contact
                                                us today at<span class="pspan">+971528133079</span> or <span
                                                    class="pspan">info@intocyber.com</span> to discover how we can drive
                                                your growth.</p>
                                        </div>
                                ...
                                <div class="nav-right-tab">
                                    <div class="sub-nav-right-tab">
                                        ...
                                        <img src="<?php bloginfo('template_url'); ?>/assets/images/Linevtcl.svg"
                                            alt="Linevtcl">
                    ...
                    <div class="main-info-block">
                        ...
                        <div class="arrow-dowm" style="display:none">
                            ...
                            <div class="arrow-down-img">
                                <img src="<?php bloginfo('template_url'); ?>/assets/images/down-arrow.svg"
                                    alt="down-arrow">
                            </div>
                        </div>
            ...
            <div id="sub-home-banner-txt">
                <div class="container">
                    <div class="banner-img-main-info-block">
                        ...
                        <?php } else { ?>
                        <img src="http://localhost/IntoCyber/wp-content/uploads/2024/05/wwd-img.png"
